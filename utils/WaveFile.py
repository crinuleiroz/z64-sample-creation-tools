...
class WaveFile:
    ...
    def parse_fmt(self):
        ...
        self.fmt_chunk.audio_format, self.fmt_chunk.num_channels, \
            self.fmt_chunk.sample_rate, self.fmt_chunk.byte_rate, \
            self.fmt_chunk.block_align, self.fmt_chunk.bits_per_sample \
